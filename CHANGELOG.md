# Versión 0.9.8.4 (en progreso)

#### Cambios:

- Actualizado el servidor a la versión 1.19.4 de Minecraft.
- Configuración de optimización re-trabajada.
- Cambiada la máxima distancia de visualización de chunks (4 -> 16).
...
- Accesos de comandos restringidos
- Bug de visualización de software del servidor
